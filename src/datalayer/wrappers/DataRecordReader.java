...
/**
 * Envoltorio para proteger el acceso al objeto ResultSet.
 * @author Victor Manuel Bucio Vargas
 */
public abstract class DataRecordReader extends ResultSetMetaDataContainer
{
    private final ResultSet decorate;
  
    public DataRecordReader(ResultSet toDectorate, ResultSetMetaData the_columns)
    {
        super (the_columns);
        decorate = toDectorate;
    }
     ...
     * access error occurs or this method is called on a closed result set
     */
    public char getCharacter(int columnIndex) throws SQLException
    {
        return decorate.getString(columnIndex).charAt(0);
    }
    ...
    {
        return decorate.getAsciiStream(columnIndex);
    }
    ...
    {
        return decorate.getUnicodeStream(columnIndex);
    }
    ...
    public java.io.InputStream getBinaryStream(int columnIndex)
            throws SQLException
    {
        return decorate.getBinaryStream(columnIndex);
    }
    ...
    {
        return decorate.getBigDecimal(columnLabel, scale);
    }
    ...
    {
        return decorate.getAsciiStream(columnLabel);
    }
    ...
    {
        return decorate.getUnicodeStream(columnLabel);
    }
    ...
    public java.io.InputStream getBinaryStream(String columnLabel)
            throws SQLException
    {
        return decorate.getBinaryStream(columnLabel);
    }
